import { LessonContent, ModuleReview } from '../types.js';
import { angularLessons } from './angular-lessons.js';
import { typescriptLessons } from './typescript-lessons.js';

export const courseContent: Record<string, LessonContent> = { ...typescriptLessons, ...angularLessons };

export const moduleReviews: Record<number, ModuleReview> = {
  0: { questions: [
