import { LearningEnvironment } from '../types.js';

export const browserEnvironment = (expected: string): LearningEnvironment => ({
...
export const academyEnvironment = (files: string[], expected: string): LearningEnvironment => ({
...
export const tsLabEnvironment = (file: string, expected: string): LearningEnvironment => ({
...
export const angularLabEnvironment = (files: string[], commands: string, expected: string): LearningEnvironment => ({
